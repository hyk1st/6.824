...
func TestInitialElection2A(t *testing.T) {
	...
	if term1 != term2 {
		fmt.Printf("warning: term changed even though there were no failures. %v ->  %v", term1, term2)
	}
...
func TestFailAgree2B(t *testing.T) {
	...
	//fmt.Println("leader id is : ", leader)
	// the leader and remaining follower should be
	// able to agree despite the disconnected follower.
	cfg.one(102, servers-1, false)
	cfg.one(103, servers-1, false)
	...
	//	fmt.Println(i, " raft map ", cfg.logs[i])
	//}
	// re-connect
	...
	//fmt.Println("after  ", "leader term", cfg.rafts[leader].currentTerm)
	//for i, v := range cfg.rafts {
	//	fmt.Println(i, " term ", v.currentTerm, " log index", v.currentLogIndex, "next index", cfg.rafts[leader].nextIndex[i], " raft map ", cfg.logs[i])
	//}
...
func TestFailNoAgree2B(t *testing.T) {
	...
	//fmt.Println(cfg.rafts[leader2].nextIndex)
	...
	//time.Sleep(RaftElectionTimeout)
	//for i, v := range cfg.rafts {
	//	fmt.Println(i, " term ", v.currentTerm, " log index", v.currentLogIndex, "next index", cfg.rafts[leader2].nextIndex[i], " raft map ", cfg.logs[i])
	//}
